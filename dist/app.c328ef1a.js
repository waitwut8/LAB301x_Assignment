...
exports.logout = exports.login = exports.getProducts = exports.default = void 0;
...
var login = exports.login = function login(user, pass) {
  console.log("login");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          (0, _api.login)(username, password).then(function (res) {
            console.log(res.data);
            localStorage.setItem('token', res.data['access_token']);
          }).catch(function (err) {
            console.log(err);
          });
          (0, _api.getProducts)().then(function (res) {
            console.log(res.data);
            (0, _api.logout)();
          }).catch(function (err) {
            console.log(err);
...
},{"./api.js":"api.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
